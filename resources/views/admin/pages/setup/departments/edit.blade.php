...
<div class="flex justify-center py-10">
    <div class="w-full max-w-3xl bg-white shadow-sm rounded-lg p-8 border border-gray-200">
        ...
        <h1 class="text-2xl font-semibold text-center">Edit Department</h1>
        ...
        <form>
            ...
            <div class="mb-5">
                ...
                <textarea rows="4"
                    class="w-full border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500">Specializes in heart-related conditions and treatments.</textarea>
            </div>
