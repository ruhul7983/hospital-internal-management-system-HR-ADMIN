...
<div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
  <h1 class="py-6 text-2xl font-semibold tracking-tight text-gray-900">Create Overtime Policy</h1>
    ...
    <div class="lg:col-span-2 space-y-6">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <input type="text" placeholder="e.g., Senior Doctor Overtime"
                 class="w-full rounded-xl border border-gray-200 bg-white px-3.5 py-2.5 text-gray-900 placeholder-gray-400 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>
        ...
        <div>
          ...
          <input type="text" value="1.5" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>

        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700">Weekend Multiplier</label>
          <input type="text" value="2.0" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>

        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700">Holiday Multiplier</label>
          <input type="text" value="2.5" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>

        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700">Daily Cap (minutes)</label>
          <input type="text" value="60" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>

        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700">Monthly Cap (minutes)</label>
          <input type="text" value="120" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>

        <div>
          <label class="mb-2 block text-sm font-medium text-gray-700">Rounding (minutes)</label>
          <input type="text" value="15" class="w-full rounded-xl border border-gray-200 px-3.5 py-2.5 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600">
        </div>
      </div>
