...
<div class="px-6 py-8">
    <div class="mx-auto max-w-4xl">
        <div class="mb-6 flex items-center justify-between">
            ...
            <a href="#" class="text-sm font-medium text-blue-600 hover:underline">Back to list</a>
        </div>
            ...
            <form method="POST" action="#" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div>
                        ...
                        <input name="role" value="{{ old('role', $employee->role ?? '') }}" type="text"
                    ...
                    <div>
                        ...
                        <input name="department" value="{{ old('department', $employee->department ?? '') }}" type="text"
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div>
                        ...
                        <input name="dob" value="{{ old('dob', optional($employee->dob ?? null)->format('Y-m-d')) }}" type="date"
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-700">Change Picture</label>
                        ...
                        <div class="mt-3 flex items-center gap-4">
                            @if (!empty($employee->picture_url))
                                <img src="{{ $employee->picture_url }}" class="h-24 w-24 rounded-full object-cover ring-1 ring-gray-200" alt="Current picture">
                            @endif
                            <img id="preview" class="hidden h-24 w-24 rounded-full object-cover ring-1 ring-gray-200"/>
                        </div>
                    </div>
