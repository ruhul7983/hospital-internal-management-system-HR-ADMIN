<aside id="sidebar"
    ...
    <div class="p-4">
        <nav class="space-y-1" id="sidebarNav">
            {{-- Dashboard --}}
            <a href={{ route("super-admin.dashboard") }} class="nav-item group flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100">
            ...
            {{-- Hospitals --}}
            <a href={{ route("super-admin.hospital.index") }} class="nav-item group flex items-center gap-3 px-3 py-2 rounded-lg text-gray-700 hover:bg-gray-100">
